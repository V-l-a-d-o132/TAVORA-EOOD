  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-screen text-center px-4">
      ...
      <div className="relative z-10">
        ...
        <p className="mt-2 text-base text-gray-600 font-mono">{location.pathname}</p>
        <p className="mt-4 text-lg md:text-xl text-gray-600">Tell me more about this page, so I can generate it</p>
      </div>
    </div>
  );
}