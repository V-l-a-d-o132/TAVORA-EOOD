...
export default function PerfektnoVideoFinalCTA() {
  return (
    <section className="max-w-4xl mx-auto px-4 md:px-16 pb-16 md:pb-24">
      <div className="p-8 md:p-12 rounded-2xl bg-[#0F1F35] text-white">
        <div className="max-w-3xl">
          <div className="text-xs text-white/70 tracking-widest uppercase mb-3">Готов да създаваш видеа като професионалист?</div>
        ...
        <div className="mt-10 pt-8 border-t border-white/10 flex flex-col sm:flex-row sm:items-center gap-4 text-xs text-white/50">
          ...
          <div className="flex items-center gap-2">
            <i className="ri-film-line text-white/60" />
            <span>Реални проекти с милиони импресии</span>
          </div>
          <div className="hidden sm:block w-1 h-1 rounded-full bg-white/20" />
          <div className="flex items-center gap-2">
            <i className="ri-smartphone-line text-white/60" />
            <span>Работи с телефон и професионална техника</span>
          </div>
        </div>
      </div>
    </section>
